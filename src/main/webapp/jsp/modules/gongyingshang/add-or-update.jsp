...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑供应商</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑供应商</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>供应商编号</label>
					<input id="gongyingshangbianhao" name="gongyingshangbianhao" class="form-control" value="" readonly>
				</div>
				<div class="form-item">
					<label>供应商名称</label>
					<input name="gongyingshangmingcheng" id="gongyingshangmingcheng" name="gongyingshangmingcheng" class="form-control" placeholder="请输入供应商名称">
				</div>
				<div class="form-item">
					<label>公司地址</label>
					<input name="gongsidizhi" id="gongsidizhi" name="gongsidizhi" class="form-control" placeholder="请输入公司地址">
				</div>
				<div class="form-item">
					<label>联系电话</label>
				...
				<div class="form-item">
					<label>经理账号</label>
					<input name="jinglizhanghao" id="jinglizhanghao" name="jinglizhanghao" class="form-control" placeholder="请输入经理账号">
				</div>
				<div class="form-item">
					<label>经理姓名</label>
					<input name="jinglixingming" id="jinglixingming" name="jinglixingming" class="form-control" placeholder="请输入经理姓名">
				</div>
	...
	<script>
		...
		function gongyingshangbianhaoUuid(){
			if($("#gongyingshangbianhao").val() == null || $("#gongyingshangbianhao").val() == "null" || $("#gongyingshangbianhao").val() == ""){
				$("#gongyingshangbianhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.jinglizhanghao != null && res.data.jinglizhanghao != ''){
							$('#jinglizhanghao').val(res.data.jinglizhanghao)
							$("#jinglizhanghao").attr('readonly','readonly');
						}
						if(res.data !=null && res.data.jinglixingming != null && res.data.jinglixingming != ''){
							$('#jinglixingming').val(res.data.jinglixingming)
							$("#jinglixingming").attr('readonly','readonly');
						}
						$(validform());
					}
				});
		...
		function dataBind(){
			...
			$("#gongyingshangbianhao").val(ruleForm.gongyingshangbianhao);	
			...
			$("#jinglizhanghao").val(ruleForm.jinglizhanghao);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.gongyingshangbianhao != null && res.data.gongyingshangbianhao != ''){

						$("#gongyingshangbianhao").val(res.data.gongyingshangbianhao);
						$("#gongyingshangbianhao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.jinglizhanghao != null && res.data.jinglizhanghao != ''){
