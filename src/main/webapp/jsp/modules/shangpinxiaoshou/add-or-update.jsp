...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑商品销售</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑商品销售</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>销售时间</label>
					<input id="xiaoshoushijian-input" class="date" name="xiaoshoushijian" size="15" type="text" readonly placeholder="请选择销售时间">
				</div>
				<div class="form-item">
					<label>员工工号</label>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#xiaoshoushijian-input").val(getCurDate());
			$("#xiaoshoushijian-input").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#xiaoshoushijian-input").val(ruleForm.xiaoshoushijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xiaoshoushijian != null && res.data.xiaoshoushijian != ''){

						$("#xiaoshoushijian-input").val(res.data.xiaoshoushijian);
						$('#xiaoshoushijianFileName').val(res.data.xiaoshoushijian)
					}
