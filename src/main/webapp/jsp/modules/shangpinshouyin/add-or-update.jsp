...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑商品收银</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑商品收银</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>总金额</label>
					<input name="zongjine" id="zongjine" name="zongjine" class="form-control" placeholder="请输入总金额">
				</div>
				<div class="form-item">
					<label>收银时间</label>
					<input id="shouyinshijian-input" class="date" name="shouyinshijian" size="15" type="text" readonly placeholder="请选择收银时间">
				</div>
				<div class="form-item">
					<label>员工工号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "shangpinshouyin/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("shangpinshouyin/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("shangpinshouyin/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shangpinshouyin/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#shouyinshijian-input").val(getCurDate());
			$("#shouyinshijian-input").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#shouyinshijian-input").val(ruleForm.shouyinshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shouyinshijian != null && res.data.shouyinshijian != ''){

						$("#shouyinshijian-input").val(res.data.shouyinshijian);
						$('#shouyinshijianFileName').val(res.data.shouyinshijian)
					}
