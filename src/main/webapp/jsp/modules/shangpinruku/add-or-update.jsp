...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑商品入库</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑商品入库</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>入库时间</label>
					<input id="rukushijian-input" class="date" name="rukushijian" size="15" type="text" readonly placeholder="请选择入库时间">
				</div>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#rukushijian-input").val(getCurDate());
			$("#rukushijian-input").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
